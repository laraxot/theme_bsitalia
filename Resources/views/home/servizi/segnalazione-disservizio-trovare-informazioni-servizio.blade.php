                ...
                <div class="col-12 col-lg-8 offset-lg-1">
                    <div class="it-page-sections-container">
                        ...
                        <section class="it-page-section mb-30" id="conditions">
                            ...
                            <x-icon-link link="Termini e condizioni di servizio" dimensione-file="(PDF 1MB)"></x-icon-link>
                        </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-30">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-10 mb-30">
                                        <x-tag label-tag="Gestione rifiuti" class="t-primary bg-tag"></x-tag>
                                        <x-tag label-tag="Igiene pubblica" class="t-primary bg-tag"></x-tag>
                                        <x-tag label-tag="Spazi verdi" class="t-primary bg-tag"></x-tag>
                                        <x-tag label-tag="Inquinamento" class="t-primary bg-tag"></x-tag>
                                    </div>
