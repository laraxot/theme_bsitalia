            ...
            <div class="card-wrapper card-space">
              <div class="card card-bg card-big">
                <div class="card-body">
                  <div class="top-icon">
                    <svg class="icon">
                      <use href="themes/BsItalia/dist/svg/sprites.svg#it-card"></use>
                    </svg>
                  </div>
                  ...
                  <a class="read-more" href="#">
                    ...
                    <span class="visually-hidden">su Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                      eiusmod tempor…</span>
                    <svg class="icon">
                      <use href="themes/BsItalia/dist/svg/sprites.svg#it-arrow-right"></use>
                    </svg>
                  </a>
                </div>
              </div>
        ...
        <div class="form-group col-md-6">
          ...
          <span class="password-icon" aria-hidden="true">
            <svg class="password-icon-visible icon icon-sm">
              <use href="themes/BsItalia/dist/svg/sprites.svg#it-password-visible"></use>
            </svg>
            <svg class="password-icon-invisible icon icon-sm d-none">
              <use href="themes/BsItalia/dist/svg/sprites.svg#it-password-invisible"></use>
            </svg>
          </span>
        </div>
      </div>
