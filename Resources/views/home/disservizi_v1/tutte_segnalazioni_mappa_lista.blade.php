        ...
        <div class="container" id="main-container">
            <div class="row justify-content-center mb-md-40 mb-lg-80">
                <div class="col-12 col-lg-10">
                    <x-breadcrumbs.cmp_breadcrumbs link2="Home" link3="Elenco segnalazioni">
                        </x-breadcrumb>
                        <x-heading type="heading" title="Elenco segnalazioni"
                            subTitle="Negli ultimi 12 mesi sono state risolte 73 segnalazioni." heading-p0=true>
                        </x-heading>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 d-none d-lg-block">
                    <x-category-list category=categories></x-category-list>
                </div>
                        ...
                        <div class="tab-pane fade show active" id="data-ex-disservizio1" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-50 mb-4 mb-lg-0">
                                    <x-button>
                                        <x-button.label cardTitle="Fai una segnalazione"
                                            cardDescription="Se vuoi aggiungere una segnalazione, puoi farlo dopo esserti autenticato con le tue
                  credenziali SPID o CIE."
                                            subtitle-class="mt-3" disservizioBtn=true></x-button.label>
                                        <x-button.text label="Segnala disservizio" modalId="modal-disservizio"
                                            class="btn btn-primary mobile-full py-3 mt-2 mb-4 mb-lg-0"></x-button.text>
                                    </x-button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="data-ex-disservizio2" role="tabpanel">
                            <div class="row">
                                <x-card type="content_box" bg-grey=true margin-class="mb-4 mb-lg-30">
                                    <x-info-button-card medium-title="Buca in via Solferino"
                ...
                <span>Verde pubblico e arredo urbano</span>"
                                        ...
                                        info=true></x-info-button-card>
                                    </x-card.content_box>

                                    <x-card type="content_box" bg-grey=true margin-class="mb-4 mb-lg-30">
                                        <x-info-button-card medium-title="Titolo segnalazione 2"
                                            label-2="Tipologia segnalazione" show-more-disservizio="true"
                                            collapse-id="collapse2" info=true></x-info-button-card>
                                        </x-card.content_box>


                                        <x-card type="content_box" bg-grey=true margin-class="mb-4 mb-lg-30">
                                            <x-info-button-card medium-title="Titolo segnalazione 3"
                                                label-2="Tipologia segnalazione" show-more-disservizio="true"
                                                collapse-id="collapse3" info=true></x-info-button-card>
                                            </x-card.content_box>
                            </div>
