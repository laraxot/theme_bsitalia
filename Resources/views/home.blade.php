...
<head>
  ...
  <title>Bootstrap Italia Playground</title>
  ...
  <link href="{{ Theme::asset('pub_theme::dist/css/bootstrap-italia-custom.min.css') }}" rel="stylesheet">
...
<body>
            ...
            <div class="col-12">
              <div class="it-header-center-content-wrapper">
                <div class="it-brand-wrapper">
                  <a href="#">
                    <svg class="icon" aria-hidden="true">
                      <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-pa"></use>
                    </svg>
                ...
                <div class="it-right-zone">
                    ...
                    <ul>
                      <li>
                        <a href="#" aria-label="Facebook" target="_blank">
                          <svg class="icon">
                            <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-facebook"></use>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a href="#" aria-label="Github" target="_blank">
                          <svg class="icon">
                            <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-github"></use>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a href="#" aria-label="Twitter" target="_blank">
                          <svg class="icon">
                            <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-twitter"></use>
                          </svg>
                        </a>
                      </li>
                    </ul>
                  ...
                  <div class="it-search-wrapper">
                    ...
                    <a class="search-link rounded-icon" aria-label="Cerca nel sito" href="#">
                      <svg class="icon">
                        <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-search"></use>
                      </svg>
                    </a>
                  </div>
                </div>
            ...
            <div class="card-wrapper card-space">
              <div class="card card-bg card-big">
                <div class="card-body">
                  <div class="top-icon">
                    <svg class="icon">
                      <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-card"></use>
                    </svg>
                  </div>
        ...
        <div class="form-group col-md-6">
          ...
          <span class="password-icon" aria-hidden="true">
            <svg class="password-icon-visible icon icon-sm">
              <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-password-visible"></use>
            </svg>
            <svg class="password-icon-invisible icon icon-sm d-none">
              <use href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-password-invisible"></use>
            </svg>
          </span>
        </div>
      </div>
          ...
          <div class="row clearfix">
            <div class="col-sm-12">
              <div class="it-brand-wrapper">
                <a href="#">
                  <svg class="icon">
                    <use xlink:href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-code-circle"></use>
                  </svg>
                  <div class="it-brand-text">
                ...
                <ul class="list-inline text-left social">
                  <li class="list-inline-item">
                    <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top">
                        <use xlink:href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-designers-italia"></use>
                      </svg><span class="visually-hidden">Designers Italia</span></a>
                  </li>
                  <li class="list-inline-item">
                    <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top">
                        <use xlink:href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-twitter"></use>
                      </svg><span class="visually-hidden">Twitter</span></a>
                  </li>
                  <li class="list-inline-item">
                    <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top">
                        <use xlink:href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-medium"></use>
                      </svg><span class="visually-hidden">Medium</span></a>
                  </li>
                  <li class="list-inline-item">
                    <a class="p-2 text-white" href="#" target="_blank"><svg class="icon icon-sm icon-white align-top">
                        <use xlink:href="node_modules/bootstrap-italia/dist/svg/sprites.svg#it-behance"></use>
  ...
  <script>window.__PUBLIC_PATH__ = 'node_modules/bootstrap-italia/dist/fonts'</script>

  <script src="node_modules/bootstrap-italia/dist/js/bootstrap-italia.bundle.min.js"></script>
