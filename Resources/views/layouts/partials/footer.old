     ...
     <div class="it-footer-main">
         <div class="container">
             ...
             @if (config('bootstrap-italia.address') ||
                 config('bootstrap-italia.socials') ||
                 config('bootstrap-italia.routes.newsletter'))
                 <section class="py-4 border-white border-top">
                     <div class="row">
                         @if (config('bootstrap-italia.address') || config('bootstrap-italia.contacts-links'))
                             <div class="col-lg-4 col-md-4 pb-2">
                                 <h4><a href="#"
                                         title="{{ trans('pub_theme::bootstrap-italia.go_to') }}: {{ trans('pub_theme::bootstrap-italia.contacts') }}">{{ trans('pub_theme::bootstrap-italia.contacts') }}</a>
                                 </h4>
                                 @if (config('bootstrap-italia.address'))
                                     <p>
                         ...
                         @if (config('bootstrap-italia.socials') || config('bootstrap-italia.routes.newsletter'))
                             <div class="col-lg-4 col-md-4 pb-2 ml-auto">
                                 @if (config('bootstrap-italia.socials'))
                                     <div class="pb-2">
                                         <h4><a href="#"
                                                 title="{{ trans('pub_theme::bootstrap-italia.go_to') }}: {{ trans('pub_theme::bootstrap-italia.follow_us') }}">{{ trans('pub_theme::bootstrap-italia.follow_us') }}</a>
                                         </h4>
                                 ...
                                 @if (config('bootstrap-italia.routes.newsletter'))
                                     <div class="pb-2">
                                         <h4><a
                                                 href="{{ config('bootstrap-italia.routes.newsletter.type') === 'route' ? route(config('bootstrap-italia.routes.newsletter.route')) : url(config('bootstrap-italia.routes.newsletter.url')) }}">{{ trans('pub_theme::bootstrap-italia.newsletter') }}</a>
                                         </h4>
                                     </div>
                                 @endif
                             </div>
 ...
 <a href="#" aria-hidden="true" data-attribute="back-to-top" class="back-to-top" id="example">
     <svg class="icon icon-light">
         <use xlink:href="{{ Theme::asset('pub_theme::dist/svg/sprite.svg') }}#it-arrow-up"></use>
     </svg>
 </a>
 <div class="cookiebar">
