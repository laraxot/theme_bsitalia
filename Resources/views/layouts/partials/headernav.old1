                ...
                <nav aria-label="Navigazione accessoria">
                  <a class="it-opener d-lg-none" data-bs-toggle="collapse" href="#menu1a" role="button"
                    ...
                    <svg class="icon" aria-hidden="true">
                      <use href="/themes/BsItalia/dist/svg/sprites.svg#it-expand"></use>
                    </svg>
                  </a>
            ...
            <div class="col-12">
              <div class="it-header-center-content-wrapper">
                <div class="it-brand-wrapper">
                  <a href="#">
                    <svg class="icon" aria-hidden="true">
                      <use href="themes/BsItalia/dist/svg/sprites.svg#it-pa"></use>
                    </svg>
                ...
                <div class="it-right-zone">
                    ...
                    <ul>
                      <li>
                        <a href="#" aria-label="Facebook" target="_blank">
                          <svg class="icon">
                            <use href="themes/BsItalia/dist/svg/sprites.svg#it-facebook"></use>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a href="#" aria-label="Github" target="_blank">
                          <svg class="icon">
                            <use href="themes/BsItalia/dist/svg/sprites.svg#it-github"></use>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a href="#" aria-label="Twitter" target="_blank">
                          <svg class="icon">
                            <use href="themes/BsItalia/dist/svg/sprites.svg#it-twitter"></use>
                          </svg>
                        </a>
                      </li>
                    </ul>
                  ...
                  <div class="it-search-wrapper">
                    ...
                    <a class="search-link rounded-icon" aria-label="Cerca nel sito" href="#">
                      <svg class="icon">
                        <use href="themes/BsItalia/dist/svg/sprites.svg#it-search"></use>
                      </svg>
                    </a>
                  </div>
                </div>
              ...
              <nav class="navbar navbar-expand-lg has-megamenu" aria-label="Navigazione principale">
                <button class="custom-navbar-toggler" type="button" aria-controls="nav1" aria-expanded="false"
                  ...
                  <svg class="icon bg-override">
                    <use href="themes/BsItalia/dist/svg/sprites.svg#it-burger"></use>
                  </svg>
                </button>
                <div class="navbar-collapsable" id="nav1" style="display: none;">
                  ...
                  <div class="close-div">
                    <button class="btn close-menu" type="button">
                      ...
                      <svg class="icon">
                        <use href="themes/BsItalia/dist/svg/sprites.svg#it-close-big"></use>
                      </svg>
                    </button>
                  </div>
